...
set CLASSPATH=%APP_HOME%\lib\micronaut-database-authentication-0.1-all.jar

@rem Execute micronaut-database-authentication
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MICRONAUT_DATABASE_AUTHENTICATION_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MICRONAUT_DATABASE_AUTHENTICATION_EXIT_CONSOLE%" exit 1
exit /b 1
